											...
											<div class="tab-pane active" role="tabpanel">
                                                <?= form_open_multipart('poktan/tambah_poktan'); ?>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="ketua" value="<?= set_value('ketua'); ?>" placeholder="Nama Ketua Kelompok"/>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="kecamatan" value="<?= set_value('kecamatan'); ?>" placeholder="Kecamatan"/>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="dusun" value="<?= set_value('dusun'); ?>" placeholder="Dusun"/>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="rt" value="<?= set_value('rt'); ?>" placeholder="RT"/>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="rw" value="<?= set_value('rw'); ?>" placeholder="RW"/>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="luas_lahan" value="<?= set_value('luas_lahan'); ?>" placeholder="Luas Lahan (Ha)"/>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="komoditas_unggul" value="<?= set_value('komoditas_unggul'); ?>" placeholder="Komoditas Unggulan"/>
