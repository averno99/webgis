									...
									<div class="card-body">
										<div class="tab-content pt-5">
											...
											<thead>
												<tr>
													<th>No</th>
													<th>Infrastruktur Dam Sarpras</th>
													<th>Jumlah</th>
													<th>Satuan</th>
												</tr>
											</thead>
                                            ...
                                            foreach ($infras as $inf) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= $inf['infra_pertanian']?>
                                                        <input type="hidden" name="infra_pertanian[]" value="<?= $inf['infra_pertanian']?>">

                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="jumlah[]" value="<?= $inf['jumlah']?>" placeholder="Jumlah"/>
                                                    </td>
                                                    <td>
                                                        <?= $inf['satuan']?>
                                                        <input type="hidden" name="satuan[]" value="<?= $inf['satuan']?>">
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
