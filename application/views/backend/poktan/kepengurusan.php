									...
									<div class="card-header card-header-tabs-line">
										<div class="card-toolbar">
											<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x" role="tablist">
												...
												<li class="nav-item mr-3">
													<a class="nav-link active" href="<?= site_url(); ?>poktan/pengurus/<?= $poktan['id'] ?>">
														<span class="nav-icon mr-2">
															<span class="svg-icon mr-3">
												...
												<li class="nav-item">
													<a class="nav-link" href="<?= site_url(); ?>poktan/infras/<?= $poktan['id'] ?>">
														<span class="nav-icon mr-2">
															<span class="svg-icon mr-3">
										...
										<div class="tab-content pt-5">
											...
											foreach ($petani as $ptn) : ?>
												<tr>
													...
													<td><?= $ptn['jabatan']?></td>
													<td><a href="<?= site_url(); ?>petani/detail/<?= $ptn['idPetani'] ?>"  class="btn btn-outline-info btn-sm"><small>Lihat</small></a></td>
												</tr>
											<?php endforeach; ?>
											</tbody>
										</table>
