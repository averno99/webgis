										...
										<div class="tab-content pt-5">
                                            ...
                                            foreach ($adminis as $adm) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= $adm['adminis_kelompok']?>
                                                        <input type="hidden" name="adminis_kelompok[]" value="<?= $adm['adminis_kelompok']?>">

                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="jumlah[]" value="<?= $adm['jumlah']?>" placeholder="Jumlah"/>
                                                    </td>
                                                    <td>
                                                        <?= $adm['satuan']?>
                                                        <input type="hidden" name="satuan[]" value="<?= $adm['satuan']?>">
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
