										...
										<div class="card card-custom card-stretch">
											...
											<div class="card-header py-3">
												<div class="card-title align-items-start flex-column">
													...
													<span class="text-muted font-weight-bold font-size-sm mt-1">Update Passwordmu</span>
												</div>
											...
											<!--begin::Form-->
												...
												<div class="card-body">
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Password Saat Ini</label>
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="password" name="passwordSekarang" placeholder="Password Saat Ini"/>
														</div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Password Baru</label>
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="password" name="passwordBaru1" placeholder="Password Baru"/>
                                                            <?= form_error('nama', ' <small class="text-danger">', '</small>'); ?>
														</div>
													</div>
                                                    <div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Ulangi Password Baru</label>
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="password" name="passwordBaru2" placeholder="Ulangi Password Baru"/>
                                                            <?= form_error('nama', ' <small class="text-danger">', '</small>'); ?>
														</div>
													</div>
