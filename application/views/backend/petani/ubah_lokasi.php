										...
										<div class="tab-content pt-5">
                                            ...
                                            foreach ($lokasi as $lks) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="luas_lahan_sendiri[]" value="<?= $lks['luas_lahan_sendiri']; ?>"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="luas_lahan_sewa[]" value="<?= $lks['luas_lahan_sewa']; ?>"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="keterangan[]" value="<?= $lks['keterangan']; ?>"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="latitude[]" value="<?= $lks['latitude']; ?>"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="longitude[]" value="<?= $lks['longitude']; ?>"/>
                                                    </td>
                                                </tr>  
                                            <?php endforeach; ?>                                           
											</tbody>
