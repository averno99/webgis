											...
											<div class="tab-pane active" role="tabpanel">
                                                <form action="" method="POST">
													...
													<div class="form-group row">
														<label class="col-form-label col-3 text-lg-right text-left">Status Pemilik</label>
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="status_pemilik">
																<?php foreach ($status as $sts) : ?>
                                            						<?php if ($sts == $prasarana['status_pemilik']) : ?>
