											...
											<tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="komoditas[]" value="<?= set_value('komoditas[]'); ?>" placeholder="Komoditas"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="luas[]" value="<?= set_value('luas[]'); ?>" placeholder="Luas"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="panen_kg[]" value="<?= set_value('panen_kg[]'); ?>" placeholder="Panen Per Kg"/>
                                                    </td>
                                                    <td>
