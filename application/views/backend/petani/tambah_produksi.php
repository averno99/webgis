                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="jenis_usaha">
																<option selected disabled>Pilih Bidang Usaha/Jenis Usaha...</option>
                                                                <?php foreach ($bidang as $bju) : ?>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="sistem_pertanian">
																<option selected disabled>Pilih Sistem Pertanian...</option>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="ip">
																<option selected disabled>Pilih Indeks Pertanaman...</option>
