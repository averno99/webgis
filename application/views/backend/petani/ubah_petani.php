							...
							<input type="hidden" name="diubah" value="<?= $user['nama']; ?>"/>
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="status_anggota">
																<?php foreach ($status as $sts) : ?>
                                            						<?php if ($sts == $petani['status_anggota']) : ?>
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="poktan">
                                                                <?php foreach ($poktan as $pkt) : ?>
                                                                    <?php if ($pkt['id'] == $petani['id_poktan']) : ?>
								...
								<div class="card card-custom mt-5">
									...
									<div class="card-body">
                                                        ...
                                                        <div class="col-lg-9 col-xl-6">
															<div class="row">
																...
																<div class="form-control">
                                                            		<img src="<?= base_url('assets/gambar/petani/') . $petani['foto']; ?>" class="img-thumbnail">
                                                        		</div>
                                                                </div>
                                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="jenis_kelamin">
																<?php foreach ($jenis_kelamin as $jns) : ?>
                                            						<?php if ($jns == $petani['jenis_kelamin']) : ?>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" name="status_keluarga" value="<?= $petani['status_keluarga']?>" placeholder="Status Dalam Keluarga"/>
														</div>
													</div>
                                                    <div class="form-group row">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<select class="form-control form-control-lg form-control-solid" name="pendidikan">
																<?php foreach ($pendidikan as $pnd) : ?>
                                            						<?php if ($pnd == $petani['pendidikan']) : ?>
                                                						<option value="<?= $pnd; ?>" selected><?= $pnd; ?></option>
                                            						<?php else : ?>
