										...
										<div class="tab-content pt-5">
											...
											<tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        Cangkul
                                                        <input type="hidden" name="sarana[]" value="Cangkul">
                                                ...
                                                <tr>
                                                    <td>2<input type="hidden" name="id[]" value="<?= $petani['id']; ?>"></td>
                                                    <td>
                                                        Handspayer
                                                        <input type="hidden" name="sarana[]" value="Handspayer">
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="jumlah[]" value="<?= set_value('jumlah[]'); ?>" placeholder="Jumlah"/>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>3<input type="hidden" name="id[]" value="<?= $petani['id']; ?>"></td>
                                                    <td>
                                                        Kendaraan Roda Dua/Empat
                                                        <input type="hidden" name="sarana[]" value="Kendaraan Roda Dua/Empat">
                                                ...
                                                <tr>
                                                    <td>4<input type="hidden" name="id[]" value="<?= $petani['id']; ?>"></td>
                                                    <td>
                                                        Pengunaan Pupuk (dalam 1 Musim Tanam)
                                                        <input type="hidden" name="sarana[]" value="Pengunaan Pupuk (dalam 1 Musim Tanam)">
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="jumlah[]" value="<?= set_value('jumlah[]'); ?>" placeholder="Jumlah"/>
                                                    </td>
												...
												<tr>
                                                    <td colspan="4">
                                                        <button type="button" id="btn-tambah-sarana" class="btn btn-success font-weight-bolder text-uppercase btn-sm">Tambah Sarana Lainnya</button>
														<button type="button" id="btn-reset-sarana" class="btn btn-danger font-weight-bolder text-uppercase btn-sm">Reset Form</button>
                                                    </td>
                                                </tr>
