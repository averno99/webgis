											...
											<tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="luas_lahan_sendiri[]" value="<?= set_value('luas_lahan_sendiri[]'); ?>" placeholder="Luas Lahan Sendiri"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="luas_lahan_sewa[]" value="<?= set_value('luas_lahan_sewa[]'); ?>" placeholder="Luas Lahan Sewa"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="keterangan[]" value="<?= set_value('keterangan[]'); ?>" placeholder="Keterangan"/>
                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="latitude[]" value="<?= set_value('latitude[]'); ?>" placeholder="Latitude"/>
                                                    </td>
                                                    <td>
