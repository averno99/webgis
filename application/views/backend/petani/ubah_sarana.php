										...
										<div class="tab-content pt-5">
                                            ...
                                            foreach ($sarana as $srn) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= $srn['sarana']?>
                                                        <input type="hidden" name="sarana[]" value="<?= $srn['sarana']?>">

                                                    </td>
                                                    <td>
                                                        <input class="form-control form-control-sm form-control-solid" type="text" name="jumlah[]" value="<?= $srn['jumlah']?>" placeholder="Jumlah"/>
                                                    </td>
                                                    <td>
                                                        <?= $srn['satuan']?>
                                                        <input type="hidden" name="satuan[]" value="<?= $srn['satuan']?>">
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
