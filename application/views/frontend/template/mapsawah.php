...
var baseLayers = [
	...
	<?php foreach ($poktan as $pkt) {
		$id = $pkt['idPoktan'];
		$site = site_url();
		$url = "<a href='".$site."FrontPoktan/detail/".$id."'>Lihat Detail</a>";
...
for(i in datasawah) {
        ...
        marker.bindPopup('<b>Nama Pemilik : '+ nama_petani +'</b><br>Nama Gapoktan : '+ nama_gapoktan + '<br>Nama Kelompok Tani : ' + nama_poktan + '<br> Jabatan : '+ jabatan_kelompok  + '<br> Luas Lahan Sendiri : ' +luas_sendiri + '<br> Luas Lahan Sewa : ' +luas_sewa  + "<br><br>" + '<a href="<?=site_url()?>FrontPetani/detail/' + id_petani +'">Lihat Detail</a>' );
